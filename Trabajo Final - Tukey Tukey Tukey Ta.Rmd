...
La metodología que se utilizará será la siguiente. Se buscará hacer un modelo de regresión lineal múltiple independientes previamente definidas, pero antes de ello se agrupará mediante clústers para  evidenciar  la importancia de la edad y ver cómo se agrupa la muestra que se tiene. La regresión que se armará al final tendrá como objetivo predecir de acuerdo a las caracterísitcas de las variables, el candidato por el cual se votó. Las opciones serán PPK, Keiko, Verónica Mendoza, abstención y nulo.  La base que se utilizará para ello es LAPOP 2019 la cual es de acceso público.     
